                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-dark" role="alert">
                                ...
                                <hr>
                                <h5>
                                    <label>0-4 คะแนน ความสามารถในการปฏิบัติกิจวัตรประจำวันน้อย (ติดเตียง)</label><br>
                                    <label>5-8 คะแนน ความสามารถในการปฏิบัติกิจวัตรประจำวันปานกลาง (ติดบ้าน)</label><br>
                                    <label>9 คะแนน ความสามารถในการปฏิบัติกิจวัตรประจำวันมาก (ติดสังคม)</label><br>
